...
On the main page, click the greeen button that says "code", and click "download zip". Extract the folder and run the .exe file in the Application folder.
### For experience GitHub users:
